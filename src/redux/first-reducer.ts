export enum ACTION_TYPES {
    SET_VALUES_AT = 'first/SET-VALUES-AT',
    SET_ERROR_AT = 'first/SET-ERROR-AT',
    SET_COUNT_AT = 'first/SET-COUNT-AT',
    SET_MAX = 'first/SET-MAX',
    SET_START = 'first/SET-START',
    SET_INITIAL_STATE = 'first/SET-INITIAL-STATE'
}
...
export const firstReducer = (state = initialState, action: CommonActionType): InitialStateType => {
    switch (action.type) {
